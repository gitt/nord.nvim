...
theme.loadLSP = function()
	...
	local lsp = {
		...
		LspReferenceText = { bg = nord.nord1_gui }, -- used for highlighting "text" references
		LspReferenceRead = { bg = nord.nord1_gui }, -- used for highlighting "read" references
		LspReferenceWrite = { bg = nord.nord1_gui }, -- used for highlighting "write" references
...
theme.loadPlugins = function()
	...
	local plugins = {
		...
		-- NvimTree
		NvimTreeRootFolder = { fg = nord.nord4_gui, style = "bold" },
		...
		NvimTreeSpecialFile = { fg = nord.nord4_gui },
